...
RSpec.describe "Dashboard" do 
  describe 'when user visits property show page' do 
    before(:each) do 
      ...
      @room1 = @property1.rooms.create!(room_type: "King", price: 59.99, smoking: true, count: 1, room_number: 115)
      @room2 = @property1.rooms.create!(room_type: "Double", price: 69.99, smoking: false, count: 1, room_number: 118)
      @room3 = @property1.rooms.create!(room_type: "Queen", price: 79.99, smoking: true, count: 1, room_number: 113)
